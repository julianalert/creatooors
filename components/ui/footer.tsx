  ...
  return (
    <footer>
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        {/* Centered content */}
        <div
          className={`flex flex-col items-center justify-center space-y-6 py-8 md:py-12 ${border ? "border-t [border-image:linear-gradient(to_right,transparent,var(--color-slate-200),transparent)1]" : ""}`}
        >
          {/* Logo */}
          <div>
            <Logo />
          ...
          <div className="text-sm text-gray-600">
            Made with 💜 by Not Another Marketer.
          </div>
